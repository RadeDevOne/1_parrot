...
YOU NEED TO HAVE ALERTS SET LIKE THIS:

<https://merakiui.com/>

THIS IS GOING TO BE POPUP, SO BUILD POPUP, INSER IT INSIDE CART AT THE END

IF USER TRIES TO INCREASE COUNT OF OUT OF STOC PRODUCT YOU SHOULD STOP THAT AND ADD INFORM THE USER WITH A POPUP THAT HE IS TRYING TO ADD TO CART MORE THAN A STOCK VALUE
