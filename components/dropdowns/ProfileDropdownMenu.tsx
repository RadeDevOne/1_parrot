...
const ProfileDropdownMenu: FC<PropsI> = ({ email, id, image, name, role }) => {
  ...
  return (
    <div tw="absolute right-0 z-20 w-56 py-2 mt-2 overflow-hidden bg-gray-300 rounded-md shadow-xl dark:bg-gray-800 ">
      ...
      <Link href={`/profile/${id}`}>
        <a tw="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-200 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
          <svg
            tw="w-5 h-5 mx-1"
            viewBox="0 0 24 24"
            fill="none"
